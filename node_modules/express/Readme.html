...
<p>  <a href="https://npmjs.org/package/express"><img src="https://img.shields.io/npm/v/express.svg" alt="NPM Version"></a>
  ...
  <a href="https://travis-ci.org/strongloop/express"><img src="https://img.shields.io/travis/strongloop/express/master.svg?label=linux" alt="Linux Build"></a>
...
<li>Visit the <a href="https://github.com/strongloop/express/wiki">Wiki</a></li>
...
<li><a href="http://expressjs.kr">한국어 문서</a> - [<a href="https://github.com/Hanul/expressjs.kr">website repo</a>]</li>
</ul>
...
<h2>Examples</h2><p>  To view the examples, clone the Express repo and install the dependancies:</p>
<pre><code class="language-bash">$ git clone git://github.com/strongloop/express.git --depth 1
$ cd express
$ npm install
</code></pre>
